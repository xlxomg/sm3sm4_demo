...
//		//C1 C2 C3拼装成加密字串
//		String encryptdata = EncryptUtil.encodeHexString(c1.getEncoded())+ EncryptUtil.encodeHexString(source)+ EncryptUtil.encodeHexString(c3);
//		return EncryptUtil.hexStringToBytes(encryptdata);
//
//		/*
...
//		String data = EncryptUtil.byteToHex(encryptedData);
//		/***分解加密字串
//		 * （C1 = C1标志位2位 + C1实体部分128位 = 130）
//		 * （C3 = C3实体部分64位  = 64）
//		 * （C2 = encryptedData.length * 2 - C1长度  - C2长度）
//		 */
//		byte[] c1Bytes = EncryptUtil.hexToByte(data.substring(0,130));
//		int c2Len = encryptedData.length - 97;
//		byte[] c2 = EncryptUtil.hexToByte(data.substring(130,130 + 2 * c2Len));
//		byte[] c3 = EncryptUtil.hexToByte(data.substring(130 + 2 * c2Len,194 + 2 * c2Len));
//
//		SM2 sm2 = SM2.Instance();
...
//		System.out.println("SM3摘要Z: " + EncryptUtil.getHexString(z));
//	    System.out.println("");
//
//	    System.out.println("M: " + EncryptUtil.getHexString(sourceData));
//		System.out.println("");
//
...
//	    sm3.doFinal(md, 0);
//
//	    System.out.println("SM3摘要值: " + EncryptUtil.getHexString(md));
//	    System.out.println("");
//
...
//		String prikS = new String(Base64.encode(EncryptUtil.hexToByte(prik)));
...
//
//		System.out.println("ID: " + EncryptUtil.getHexString(userId.getBytes()));
//		System.out.println("");
//
//		System.out.println("签名: ");
//		byte[] c = SM2Utils.sign(userId.getBytes(), Base64.decode(prikS.getBytes()), sourceData);
//		System.out.println("sign: " + EncryptUtil.getHexString(c));
//		System.out.println("");
//
//		// 国密规范测试公钥
...
//		String pubkS = new String(Base64.encode(EncryptUtil.hexToByte(pubk)));
...
//		System.out.println("加密: ");
//		byte[] cipherText = SM2Utils.encrypt(EncryptUtil.hexStringToBytes(pubk), sourceData);
...
//		plainText = EncryptUtil.encodeHexString(SM2Utils.decrypt(EncryptUtil.hexStringToBytes(prik), EncryptUtil.hexStringToBytes(data)));
//		System.out.println(plainText);
//
//	}
//
